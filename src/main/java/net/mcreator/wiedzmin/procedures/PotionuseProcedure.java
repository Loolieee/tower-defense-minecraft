...
public class PotionuseProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WiedzminMod.LOGGER.warn("Failed to load dependency world for procedure Potionuse!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WiedzminMod.LOGGER.warn("Failed to load dependency x for procedure Potionuse!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WiedzminMod.LOGGER.warn("Failed to load dependency y for procedure Potionuse!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WiedzminMod.LOGGER.warn("Failed to load dependency z for procedure Potionuse!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WiedzminMod.LOGGER.warn("Failed to load dependency entity for procedure Potionuse!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				WiedzminMod.LOGGER.warn("Failed to load dependency itemstack for procedure Potionuse!");
			return;
		}
		...
		if (entity instanceof LivingEntity)
			((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.REGENERATION, (int) 180, (int) 2, (false), (false)));
		if (new Object() {
